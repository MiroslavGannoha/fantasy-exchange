...
import { Offer_select_column } from './Offer_select_columnEnum'
import { order_by } from './order_byEnum'
import { Player_select_column } from './Player_select_columnEnum'
import { conflict_action } from './conflict_actionEnum'
import { Offer_constraint } from './Offer_constraintEnum'
import { Offer_update_column } from './Offer_update_columnEnum'
import { Player_constraint } from './Player_constraintEnum'
import { Player_update_column } from './Player_update_columnEnum'
...
export const RootStoreBase = MSTGQLStore
  ...
  .actions(self => ({
    queryOffer(variables: { distinct_on: Offer_select_column[], limit: number | undefined, offset: number | undefined, order_by: Offer_order_by[], where: Offer_bool_exp | undefined }, resultSelector: string | ((qb: OfferModelSelector) => OfferModelSelector) = offerModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryOffer_aggregate(variables: { distinct_on: Offer_select_column[], limit: number | undefined, offset: number | undefined, order_by: Offer_order_by[], where: Offer_bool_exp | undefined }, resultSelector: string | ((qb: Offer_aggregateModelSelector) => Offer_aggregateModelSelector) = offer_aggregateModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryPlayer(variables: { distinct_on: Player_select_column[], limit: number | undefined, offset: number | undefined, order_by: Player_order_by[], where: Player_bool_exp | undefined }, resultSelector: string | ((qb: PlayerModelSelector) => PlayerModelSelector) = playerModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryPlayer_aggregate(variables: { distinct_on: Player_select_column[], limit: number | undefined, offset: number | undefined, order_by: Player_order_by[], where: Player_bool_exp | undefined }, resultSelector: string | ((qb: Player_aggregateModelSelector) => Player_aggregateModelSelector) = player_aggregateModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    mutateInsert_Offer(variables: { objects: Offer_insert_input[] }, resultSelector: string | ((qb: Offer_mutation_responseModelSelector) => Offer_mutation_responseModelSelector) = offer_mutation_responseModelPrimitives.toString(), optimisticUpdate?: () => void) {
      return self.mutate<typeof Offer_mutation_responseModel.Type>(`mutation insert_Offer($objects: [Offer_insert_input!]!) { insert_Offer(objects: $objects) {
        ${typeof resultSelector === 'function' ? resultSelector(new Offer_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateInsert_Player(variables: { objects: Player_insert_input[] }, resultSelector: string | ((qb: Player_mutation_responseModelSelector) => Player_mutation_responseModelSelector) = player_mutation_responseModelPrimitives.toString(), optimisticUpdate?: () => void) {
      return self.mutate<typeof Player_mutation_responseModel.Type>(`mutation insert_Player($objects: [Player_insert_input!]!) { insert_Player(objects: $objects) {
        ${typeof resultSelector === 'function' ? resultSelector(new Player_mutation_responseModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    subscribeOffer(variables: { distinct_on: Offer_select_column[], limit: number | undefined, offset: number | undefined, order_by: Offer_order_by[], where: Offer_bool_exp | undefined }, resultSelector: string | ((qb: OfferModelSelector) => OfferModelSelector) = offerModelPrimitives.toString(), onData?: (item: any) => void) {
    ...
    subscribeOffer_aggregate(variables: { distinct_on: Offer_select_column[], limit: number | undefined, offset: number | undefined, order_by: Offer_order_by[], where: Offer_bool_exp | undefined }, resultSelector: string | ((qb: Offer_aggregateModelSelector) => Offer_aggregateModelSelector) = offer_aggregateModelPrimitives.toString(), onData?: (item: any) => void) {
    ...
    subscribePlayer(variables: { distinct_on: Player_select_column[], limit: number | undefined, offset: number | undefined, order_by: Player_order_by[], where: Player_bool_exp | undefined }, resultSelector: string | ((qb: PlayerModelSelector) => PlayerModelSelector) = playerModelPrimitives.toString(), onData?: (item: any) => void) {
